   ...
   public BufferedImage read(InputStream var1, boolean var2) throws IOException {
      if (var1 == null) {
         ...
         try {
            ...
            int var19;
            for(HashSet var7 = new HashSet(); var5.getState() != 6; var6.endChunk(var19)) {
               var19 = var6.startChunk();
               var5.nextState(var19);
               ...
               try {
                  ...
                  if (var19 == 1229209940) {
                     ...
                     default:
                        ...
                        while((var19 = var5.getType()) == 1229209940) {
                  ...
                  String var10002;
                  if (!this.isMultipleOK(var19) && !var7.add(Integers.valueOf(var19))) {
                     var10002 = PngConstants.getChunkName(var19);
                     throw new PngException("Multiple " + var10002 + " chunks are not allowed", !PngConstants.isAncillary(var19));
                  }

                  try {
                     this.readChunk(var19, var6, var6.getOffset(), var6.getRemaining());
                  } catch (PngException var15) {
                     throw var15;
                  } catch (IOException var16) {
                     var10002 = PngConstants.getChunkName(var19);
                     throw new PngException("Malformed " + var10002 + " chunk", var16, !PngConstants.isAncillary(var19));
                  }

                  skipFully(var6, (long)var6.getRemaining());
                  if (var19 == 1229472850 && var3 == 1) {
                     var9 = null;
                     return var9;
                  }
